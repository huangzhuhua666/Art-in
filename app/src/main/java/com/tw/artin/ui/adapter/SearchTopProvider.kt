...
class SearchTopProvider(val mFragment : DeviceFragment) : BaseItemProvider<DevicesBean>() {
    ...
    override fun onChildClick(
        ...
        when(view.id){
            ...
            R.id.iv_play -> {
                (getAdapter() as DeviceListAdapter).clearSearch()
                ...
                getAdapter()?.data?.let { datas ->
                    ...
                    datas.filter { it.type == 1 && it.isSelect == true}.run {
                        ...
                        if (isEmpty()){
                            ...
                            mFragment.getAttachActivity().mainControl.let {
                                ...
                                mapIndexed { index, devicesBean ->
                                    ...
                                    it.getLinkData()?.let { lIt ->
                                        it.connetBle(lIt.scan_datas,true)
                                    }
                                }
