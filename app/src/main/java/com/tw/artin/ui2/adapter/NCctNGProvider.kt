...
class NCctNGProvider(val mFragment : NCctFragment) : BaseNodeProvider() {

    override val itemViewType: Int = 2

    override val layoutId: Int = R.layout.cct_ng_provider
            ...
            helper.getView<RangeSeekBar>(R.id.seek_bar_g).let {
                ...
                it.setOnRangeChangedListener(object : OnRangeChangedListener{
                    ...
                    override fun onStopTrackingTouch(view: RangeSeekBar?, isLeft: Boolean) {
                        ...
                        if (isLeft && mFragment.changeList[3] == 1){
