...
class NEffectGProvider(val mFragment : NEffectFragment) : BaseNodeProvider() {

    override val itemViewType: Int = 0

    override val layoutId: Int = R.layout.effect_g_provider
    ...
    override fun convert(helper: BaseViewHolder, item: BaseNode) {
        ...
        if (item is NControllerGruoupBean){
            ...
            when(item.effect){
                ...
                0 -> helper.setImageResource(R.id.iv_fm, R.mipmap.icon_e4)

                1 -> helper.setImageResource(R.id.iv_fm, R.mipmap.icon_e3)

                2 -> helper.setImageResource(R.id.iv_fm, R.mipmap.icon_e1)

                3 -> helper.setImageResource(R.id.iv_fm, R.mipmap.icon_e2)

                4 -> helper.setImageResource(R.id.iv_fm, R.mipmap.icon_e7)

                5 -> helper.setImageResource(R.id.iv_fm, R.mipmap.icon_e6)

                6 -> helper.setImageResource(R.id.iv_fm, R.mipmap.icon_e5)
            }
            ...
            helper.getView<RangeSeekBar>(R.id.seek_bar_g).let {
                ...
                it.setOnRangeChangedListener(object : OnRangeChangedListener {
                    ...
                    override fun onStopTrackingTouch(view: RangeSeekBar?, isLeft: Boolean) {
                        ...
                        if (isLeft && mFragment.changeList[0] == 1){
                            ...
                            (getAdapter() as NEffectAdapter)?.let { adapter ->
    ...
    override fun onClick(helper: BaseViewHolder, view: View, data: BaseNode, position: Int) {
        ...
        if (data is NControllerGruoupBean){
            ...
            if (!data.isSelect){
                ...
                (getAdapter() as NEffectAdapter).selectItem(position,true)
            }
        }
