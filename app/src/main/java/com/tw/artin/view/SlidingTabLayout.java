...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    int Gonepos = 0;
    Boolean isGone_statue = false;
    public void setGoneText(int pos,Boolean isGone,String text){

        Gonepos = pos;

        isGone_statue = isGone;

        if (isGone){
            mTitles.set(pos,"");
        }else{
            mTitles.set(pos,text);
        }
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isGone_statue && position == Gonepos){
                    return;
                }
    ...
    public void UpDataPos(Integer pos){
        mCurrentTab = pos;
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setTabsNotViewPager(ArrayList<String> titles) {
        mTitles = titles;
        notifyDataSetChanged();
    }
